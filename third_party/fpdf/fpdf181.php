...
function __construct($orientation='P', $unit='mm', $size='A4')
{
	...
	$this->StdPageSizes = array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		...
		'cfb'=> array(793.7008, 992.126), 'cfs' => array(609.4488,793.7008), 'F4' => array(609.4488,935.4331)
		);
	*/	
		
	$this->StdPageSizes = array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 
		'cfb'=> array(792, 1071), 'cfs' => array(684,792), 'F4' => array(609.4488,935.4331)
		);
...
function Add_Page($orientation='P', $size='A4', $max_lenght=0)
{	
	$max_lenght = ($max_lenght + 30) ;
	$nWidth = 210 ; 
	$nHeight = 297 ;
	switch ($orientation){
		case 'P' :
			switch ($size){
				case 'F4' :
					$nWidth = Max(215,$max_lenght);
					$nHeight = $nWidth * (330 / 215 );
					break ;
					
				case 'A4' :
					$nWidth = Max(215,$max_lenght);
					$nHeight = $nWidth * (297 / 215 );  
					break ;
				case 'CFS' :
					$nWidth = Max(241.3,$max_lenght);
					$nHeight = $nWidth * (279.4 / 241.3 );  
					break ;
				case 'CFB' :
					$nWidth  = Max(377.825,($max_lenght ));
					$nHeight =  $nWidth * (377.825 / 279.4 ) ;  
					/*
					$nWidth  = Max(350,$max_lenght);
					$nHeight =  $nWidth * (350 / 280 );  
					*/
					break ;
				case 'A3' :
					$nWidth  = Max(420,$max_lenght);
					$nHeight =  $nWidth * (420 / 297 );  
					break ;
				case 'A5' :
					$nWidth  = Max(215,$max_lenght);
					$nHeight = $nWidth * (210 /(297 /2) );    
		...
		case 'L' :
			switch ($size){
				case 'F4' :
					$nWidth = Max(330,$max_lenght);
					$nHeight=   $nWidth * (215 / 330)  ;
					break ;
				case 'A4' :
					$nWidth = Max(297,$max_lenght);
					$nHeight =   $nWidth * (215 / 297)  ;
					break ;
				case 'A3' : 
					$nWidth  = Max(420,$max_lenght);
					$nHeight=   $nWidth * ( 297/ 420)  ;
					break ;
				case 'A5' :
					$nWidth = Max(210,$max_lenght);
					$nWidth=   $nHeight * ((297/2) / 210)  ;
					break ;
				case 'CFS' :
					$nWidth = Max(279.4,$max_lenght);
					$nHeight =   $nWidth * (241.3 / 279.4)  ;
					break ;
				case 'CFB' : 
					$nWidth  = Max(377.825,$max_lenght);
					$nHeight=   $nWidth * ( 279.4/ 377.825)  ;
					break ;
			}
			break ;	
	}
